            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 mt-3 mb-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <label for="namawarung" class="col-4 col-form-label">Nama Warung</label>
                                <div class="col-8 mt-2 mt-2">
                                    <div class="d-flex align-items-start">
                                        <span class="mr-1">:</span>
                                        <label class="text-break">{{ $warung->nama }}</label>
                                    </div>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="nomorhpwarung" class="col-4 col-form-label">No. Hp</label>
                                <div class="col-8 mt-2">
                                    <div class="d-flex align-items-start">
                                        <span class="mr-1">:</span>
                                        <label class="text-break">{{ $warung->nomorhp }}</label>
                                    </div>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="alamatwarung" class="col-4 col-form-label">Alamat Lengkap</label>
                                <div class="col-8 mt-2">
                                    <div class="d-flex align-items-start">
                                        <span class="mr-1">:</span>
                                        <label class="text-break">{{ $warung->alamat }}</label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 mt-2">
                                    <div class="d-flex align-items-start">
                                        <span class="mr-1">:</span>
                                        <label class="text-break">{{ $warung->kodepos }}</label>
                                    </div>
                                </div>
                            </div>

                            <div class="row">
                                <label for="biodatawarung" class="col-4 col-form-label">Biodata</label>
                                <div class="col-8 mt-2">
                                    <div class="d-flex align-items-start">
                                        <span class="mr-1">:</span>
                                        <label class="text-break">{{ $warung->biodata }}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($barang as $item)
                                <tr>
                                    ...
                                    @if ($users_id && $warung->users_id === $users_id->id)
                                        <td class="text-center">
                                            {{-- <a class="badge bg-warning text-white" type="submit" href="/warung/{{$warung->id}}/barang/{{$item->id}}">Edit</a> --}}
                                            <!-- Button trigger modal -->
