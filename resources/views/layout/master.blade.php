    ...
    <div class="container-fluid bg-secondary text-dark mt-5">
        ...
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-5 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p>E-warung adalah istilah untuk warung kecil berbasis online yang menjual kebutuhan sehari-hari</p>
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            @auth
                                @if ( Auth::user()->kategori == 'Pembeli')
                                    ...
                                    <a class="text-dark mb-2" href="/checkout"><i class="fa fa-angle-right mr-2"></i>Check-out</a>
                                @endif
                            @endauth
                            <a class="text-dark mb-2" href="/contact"><i class="fa fa-angle-right mr-2"></i>Kontak</a>
                            <a class="text-dark mb-2" href="/login"><i class="fa fa-angle-right mr-2"></i>Masuk</a>
                            <a class="text-dark" href="/register"><i class="fa fa-angle-right mr-2"></i>Daftar</a>
                        </div>
                    </div>
                    <div class="col-md-3 mb-5">
                    </div>
                    <div class="col-md-4 mb-5">
                        <h5 class="font-weight-bold text-dark mb-4">Berita</h5>
                        <form action="">
                            ...
                            <div>
                                <button class="btn btn-primary btn-block border-0 py-3" type="submit">Berlangganan Sekarang</button>
                            </div>
                        </form>
                    </div>
                </div>
